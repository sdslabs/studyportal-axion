        ...
        return(
            <div className='customfileuploader'>
                <div className='customfileuploader--input'>
                    <input className='customfileuploader--choosefile' type='file' multiple onChange={addFiles}/>
                ...
                {props.uploaded ?
                    <div className='customfileuploader--button_uploaded' onClick={() => refreshUpload()}>
                        Upload More</div> : props.uploading ?
        ...
        return(
            ...
            <div>
                {files.map((fileObj, index) => (
                    <FileUploadContainer uploading={props.uploadings[index]}
                ...
                <div className={props.disabled ? 'customfileuploader--input-disabled' : 'customfileuploader--input'}>
                    <input className='customfileuploader--choosefile' type='file' multiple onChange={addFiles}/>
                    <label className='customfileuploader--label'>Choose File</label>
