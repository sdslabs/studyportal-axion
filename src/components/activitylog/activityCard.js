        ...
        <div className="activitycard--info">
          <div className="activitycard--info_date">
            <span className="activitycard--info_head">
              {this.props.type === 'request' ? 'Requested On: ' : 'Uploaded On: '}
            </span>
        ...
        {this.state.status === 1 ? (
          ...
          <Fragment>
            <div className="activitycard--status_green">
              <img className="req_color" src={green} alt="green" /> Files Uploaded (
              {this.state.status}/3)
            </div>
            <div className="activitycard--file">
              <img className="activitycard--file_download" src={download} alt="download" /> Tutorial
              1 Structural Analysis CEN-207
            </div>
          </Fragment>
        )}
      </div>
